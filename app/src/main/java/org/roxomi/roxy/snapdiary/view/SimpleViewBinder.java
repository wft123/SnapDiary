package org.roxomi.roxy.snapdiary.view;
...
import org.roxomi.roxy.snapdiary.R;
import org.roxomi.roxy.snapdiary.adapters.AdapterRCVBase;
import org.roxomi.roxy.snapdiary.adapters.AdapterRcvSimple;
...
public class SimpleViewBinder {
    ...
    public static class RecyclerViewBuilder implements Builder {
        ...
        public RecyclerViewBuilder setAdapter(AdapterRcvSimple adapter, FragmentManager fm) {
